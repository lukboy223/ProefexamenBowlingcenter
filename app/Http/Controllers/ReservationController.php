...
class ReservationController extends Controller
{
    ...
    public function update(Request $request, $id){
        ...
        try{
            ...
            DB::select('call sp_update_reservation(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [
                $id,
                $request->input('CustomerId'),
                $BowlingLaneId,
                $request->input('ReservationDate'),
            ...
            return redirect()->route('reservation.index')->with('success', 'Reservering succesvol aangepast.');
            ...
            return redirect()->route('reservation.edit', $id)->with('error', 'Er is iets fout gegaan bij het wijzigen van de reservering');
        }
        dd($request);
    }
